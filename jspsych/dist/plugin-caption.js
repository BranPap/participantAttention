var jsPsychCaption = (function (jspsych) {
  'use strict';
  ...
  const info = {
      ...
      parameters: {
          ...
          /** Image File to be displayed as stimulus */
          image_file: {
              type: jspsych.ParameterType.IMAGE,
              pretty_name: "Image Source",
              default: ""
          }
      },
  };
  ...
  class ClozePlugin {
      ...
      trial(display_element, trial) {
          ...
          if (trial.image_file != "") {
              html += "<div style='display: flex; justify-content: center; margin: 0 auto; width: 25%;'><img src='" + trial.image_file + "'id='jspsych-iat-stim' style='width: 100%; height: auto; margin-bottom: 20px'></div>"
          } 
