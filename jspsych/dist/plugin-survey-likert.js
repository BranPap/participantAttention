/** Please note that this version of the likert survey has been modified with custom css styling for Papineau & Hawkins (forthcoming). It is intended to look like part of a newspaper-themed study */
...
var jsPsychSurveyLikert = (function (jspsych) {
  ...
  class SurveyLikertPlugin {
      ...
      trial(display_element, trial) {
          ...
          // Update the CSS injection part of the plugin
...
html += `
    ...
    /* Style the radio buttons to look more vintage */
    input[type="radio"] {
